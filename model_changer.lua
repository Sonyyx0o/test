local t_player_models = {
    ...
    ["ogloc"] = "models/player/custom_player/legacy/bew/bew/gta/ogloc.mdl",
    ["ballas1"] = "models/player/custom_player/eminem/gta_sa/ballas1.mdl",
    ["arctic"] = "models/player/custom_player/legacy/tm_arctic_variantd.mdl",
    ...
    ["neverlose"] = "models/player/custom_player/frnchise9812/neverlosee.mdl",
